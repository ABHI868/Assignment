# Generated by Django 2.1.4 on 2018-12-24 16:19
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('MovieInfo', '0005_auto_20181224_1354'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='author',
            name='author_rating',
            field=models.FloatField(validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(9.9)]),
        ),
        migrations.AlterField(
            model_name='book',
            name='currency',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='INR', max_digits=14),
        ),
    ]
